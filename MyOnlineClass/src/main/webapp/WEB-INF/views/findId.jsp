...
<head>
  ...
  <title>아이디 찾기 | Hyundai Cosmetic</title>
...
<div class="table-content">
 ...
 <div class="container">
   ...
   <div class="jumbotron" style="height: 100%">
      ...
      <form action="${pageContext.request.contextPath}/member/findIdAction" class="was-validated" method="post">
          ...
          <div class="form-group" style="width: 50%;margin: 20px auto 0px;text-align: center;">
             비밀번호를 모르신다면?&nbsp;<a href="${pageContext.request.contextPath}/move/findPw">비밀번호 찾기</a>
          </div>
      </form>
   </div>
  </div>
