...
<head>
	...
	<script>
		...
		function delBtn(){
			...
			//var hz = document.getElementsByClassName('video__items active')
			//console.log(hz);
			//alert(hz);
		...
		<div class="video__nav">
			...
			<div class=lecturer_div>
   					 ...
   					 <c:if test="${isInstructor eq true}">
	 					...
	 					<input type="button" value="강의 삭제" class="vodDelete" onclick="javascript:delBtn();">
